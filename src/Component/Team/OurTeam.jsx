        ...
        <div>
            <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
                    ...
                    <p className="max-w-2xl text-center dark:text-gray-600">An industrial estate is a place where the required facilities and factory accommodation are provided by the government to the entrepreneurs to establish their industries there.</p>
